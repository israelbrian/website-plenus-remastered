...
import { ChatBubbleLeftRightIcon } from '@heroicons/react/24/solid'; // Using as generic chat icon or similar if needed, or re-import specific
            ...
            <ul className="flex flex-col gap-4 font-family-body text-sm">
              ...
              <li>
                <Link href="https://wa.me/3185697977" target="_blank" className="flex items-center gap-3 hover:text-color-accent transition-colors">
                  <ChatBubbleLeftRightIcon className="w-5 h-5 text-color-accent" />
